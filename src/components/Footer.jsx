          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">
                Deploy a High-Converting Strategy, Risk-Free
              </h3>
              <p className="section-copy max-w-lg">
                Ready to partner with a hungry agency that guarantees outcomes? Start with zero risk.
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr_1fr] gap-10">
          ...
          <div>
            ...
            <p className="text-white/40 text-sm leading-relaxed mb-6">
              Hungry minds delivering risk-free engineering for ambitious brands worldwide.
            </p>
            <div className="space-y-2 text-sm mb-6">
              <p className="flex gap-3"><strong className="text-white/30 w-16 flex-shrink-0">Address</strong><span className="text-white/60">276 Holten Ave, New York, United States</span></p>
